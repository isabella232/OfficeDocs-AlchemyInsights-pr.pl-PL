...
Aby wyczyścić wszystkie usunięte wiadomości programu Outlook, przejdź do [folderu Elementy usunięte](https://outlook.live.com/mail/deleteditems)i wybierz **pusty folder**, a następnie wybierz **Odzyskaj elementy usunięte z tego folderu** nad listą wiadomości i wybierz **pusty folder**  ponownie.
