...
5. **Ponowne indeksowanie** zawartości, wykonując kroki opisane w [ręcznie zażądać i ponownego indeksowania danej witryny, listy lub biblioteki](https://docs.microsoft.com/sharepoint/crawl-site-content). To może trochę potrwać, odczekać 24 godziny przed ponownym sprawdzaniem wyników.
