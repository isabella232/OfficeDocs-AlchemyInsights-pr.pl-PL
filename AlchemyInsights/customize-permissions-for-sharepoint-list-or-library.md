...
Jako administrator lub właściciel biblioteki, listy lub ankiety możesz zmienić uprawnienia, aby umożliwić jednej grupie osób dostęp do potrzebnych im danych, ograniczając jednocześnie inne osoby.
