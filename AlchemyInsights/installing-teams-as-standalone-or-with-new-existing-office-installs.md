...
Usługi Teams można wdrożyć jako samodzielne dla użytkowników, postępując zgodnie z tymi https://teams.microsoft.com/downloads [instrukcjami,](https://docs.microsoft.com/MicrosoftTeams/msi-deployment)lub użytkownicy mogą instalować zespoły dla siebie z .
