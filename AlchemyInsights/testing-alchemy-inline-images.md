...
---
# <a name="access-the-domains-page"></a><span data-ttu-id="d49c5-102">Dostęp do strony domeny</span><span class="sxs-lookup"><span data-stu-id="d49c5-102">Access the Domains Page</span></span>

<span data-ttu-id="d49c5-103">Aby uzyskać dostęp do strony domen, po prostu kliknij tę ikonę poniżej:</span><span class="sxs-lookup"><span data-stu-id="d49c5-103">To access the domains page, just click this icon below:</span></span>
...
<span data-ttu-id="d49c5-104">Następnie możesz dodać, zmodyfikować lub usunąć domenę.</span><span class="sxs-lookup"><span data-stu-id="d49c5-104">Then you can add, modify, or remove your domain.</span></span>
<span data-ttu-id="d49c5-105">Aby uzyskać więcej informacji, zobacz sekcję [często zadawane pytania dotyczące domen.](https://docs.microsoft.com/office365/admin/setup/domains-faq)</span><span class="sxs-lookup"><span data-stu-id="d49c5-105">For more information, see the [Domains FAQ.](https://docs.microsoft.com/office365/admin/setup/domains-faq)</span></span>
