...
---
# <a name="access-the-domains-page"></a><span data-ttu-id="66a10-102">Dostęp do strony Domeny</span><span class="sxs-lookup"><span data-stu-id="66a10-102">Access the Domains Page</span></span>

<span data-ttu-id="66a10-103">Aby uzyskać dostęp do strony domen, kliknij tę ikonę poniżej:</span><span class="sxs-lookup"><span data-stu-id="66a10-103">To access the domains page, just click this icon below:</span></span>
...
<span data-ttu-id="66a10-104">Następnie możesz dodać, zmodyfikować lub usunąć domenę.</span><span class="sxs-lookup"><span data-stu-id="66a10-104">Then you can add, modify, or remove your domain.</span></span>
<span data-ttu-id="66a10-105">Aby uzyskać więcej informacji, zobacz często zadawane [pytania dotyczące domen.](https://docs.microsoft.com/office365/admin/setup/domains-faq)</span><span class="sxs-lookup"><span data-stu-id="66a10-105">For more information, see the [Domains FAQ.](https://docs.microsoft.com/office365/admin/setup/domains-faq)</span></span>
