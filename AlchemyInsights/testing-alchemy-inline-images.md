---
title: Testowanie obrazów wbudowanych Alchemii
ms.author: pebaum
author: pebaum
ms.date: 04/21/2020
ms.audience: ITPro
...
ms.locfileid: "44505065"
---
# <a name="access-the-domains-page"></a><span data-ttu-id="76234-102">Dostęp do strony Domeny</span><span class="sxs-lookup"><span data-stu-id="76234-102">Access the Domains Page</span></span>

<span data-ttu-id="76234-103">Aby uzyskać dostęp do strony domen, kliknij tę ikonę poniżej:</span><span class="sxs-lookup"><span data-stu-id="76234-103">To access the domains page, just click this icon below:</span></span>
...
<span data-ttu-id="76234-104">Następnie możesz dodać, zmodyfikować lub usunąć domenę.</span><span class="sxs-lookup"><span data-stu-id="76234-104">Then you can add, modify, or remove your domain.</span></span>
<span data-ttu-id="76234-105">Aby uzyskać więcej informacji, zobacz często zadawane [pytania dotyczące domen.](https://docs.microsoft.com/microsoft-365/admin/setup/domains-faq)</span><span class="sxs-lookup"><span data-stu-id="76234-105">For more information, see the [Domains FAQ.](https://docs.microsoft.com/microsoft-365/admin/setup/domains-faq)</span></span>
