---
title: Testowanie obrazów Alchemy w tekście
ms.author: pebaum
author: pebaum
ms.date: 04/21/2020
ms.audience: ITPro
...
ms.locfileid: "53998342"
---
# <a name="access-the-domains-page"></a>Uzyskiwanie dostępu do strony Domeny

Aby uzyskać dostęp do strony domen, po prostu kliknij poniżej tę ikonę:
...
Następnie możesz dodawać, modyfikować lub usuwać domenę.
Aby uzyskać więcej informacji, zobacz Często [zadawane pytania dotyczące domen.](https://docs.microsoft.com/microsoft-365/admin/setup/domains-faq)
