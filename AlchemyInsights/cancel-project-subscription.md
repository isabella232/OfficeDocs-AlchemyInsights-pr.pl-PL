...
Administratorzy mogą anulować subskrypcję projektu dla swojej organizacji w centrum administracyjnym usługi Microsoft 365.

1. Przejdź do strony **rozliczanie** \> [produktów](https://go.microsoft.com/fwlink/p/?linkid=842054) .
2. Na karcie **produkty** Znajdź subskrypcję projektu, którą chcesz anulować. Wybierz pozycję **więcej akcji** (trzy kropki), a następnie wybierz pozycję **Anuluj subskrypcję**.
