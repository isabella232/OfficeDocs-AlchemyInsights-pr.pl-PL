...
Aby uzyskać więcej informacji dotyczących sposobu tworzenia lokacji centralnej z nowego Centrum administracyjnego lub Microsoft PowerShell, zobacz [Tworzenie lokacji centralnej w dokumentacji Online programu SharePoint](https://docs.microsoft.com/en-us/sharepoint/create-hub-site) . 
...
Aby uzyskać więcej informacji dotyczących sposobu usuwania istniejącej lokacji centralnej z nowego Centrum administracyjnego lub środowiska PowerShell, zobacz [Usuwanie lokacji centralnej](https://docs.microsoft.com/en-us/sharepoint/remove-hub-site) . 
