...
1. Przegląd [tego dokumentu](https://docs.microsoft.com/intune/apple-mdm-push-certificate-get) mają zostać skonfigurowane lub odnowienia certyfikatu push Apple MDM.
