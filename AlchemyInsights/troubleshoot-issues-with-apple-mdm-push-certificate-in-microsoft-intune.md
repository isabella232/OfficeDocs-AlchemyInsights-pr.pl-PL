...
---
# <a name="troubleshoot-issues-with-apple-mdm-push-certificate-in-microsoft-intune"></a>Rozwiązywanie problemów z Apple MDM Push Certificate w Microsoft Intune

Przejrzyj zasoby wymienione poniżej, aby rozwiązać problem teraz. 
  
1. Przegląd [tego dokumentu](https://docs.microsoft.com/en-us/intune/apple-mdm-push-certificate-get) mają zostać skonfigurowane lub odnowienia certyfikatu push Apple MDM. 
