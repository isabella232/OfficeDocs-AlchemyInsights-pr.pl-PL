...
ms.locfileid: "43767619"
---
# <a name="user-permissions-in-sharepoint"></a>Uprawnienia użytkowników w programie SharePoint

Po utworzeniu witryny programu SharePoint można udostępnić lub ograniczyć dostęp użytkowników do witryny lub jej zawartości. Najprostszym sposobem pracy z uprawnieniami jest użycie [domyślnych grup](https://docs.microsoft.com/sharepoint/default-sharepoint-groups) i poziomów uprawnień, które obejmują większość typowych scenariuszy. Ale jeśli zajdzie taka potrzeba, można ustawić bardziej szczegółowe uprawnienia poza domyślne poziomy. Aby uzyskać więcej informacji, zobacz [Opis poziomów uprawnień w programie SharePoint](https://docs.microsoft.com/sharepoint/understanding-permission-levels).

Aby uzyskać więcej informacji na temat zarządzania określonymi poziomami uprawnień, odwiedź poniższe linki:

- [Edytowanie i zarządzanie uprawnieniami do listy lub biblioteki programu SharePoint](https://support.office.com/article/customize-permissions-for-a-sharepoint-list-or-library-02d770f3-59eb-4910-a608-5f84cc297782)
...
- [Udostępnianie plików lub folderów programu SharePoint w usłudze Microsoft 365](https://support.office.com/article/share-sharepoint-files-or-folders-1fe37332-0f9a-4719-970e-d2578da4941c)
