...
3. Wybierz z listy rozwijanej strzałki w obszarze **Dodaj lub wybierz metodę płatności**, wybierz karty kredytowej lub konta bankowego, który chcesz usunąć, a następnie wybierz polecenie **Usuń**.
    
4. Wybierz polecenie **Usuń** ponownie, aby usunąć karty kredytowej lub konta bankowego. 
