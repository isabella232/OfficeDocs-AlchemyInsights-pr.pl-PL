...
Przed zaimportowanie kontaktów do Outlook.com, należy wyeksportować je z innego dostawcy poczty e-mail jako plik csv. Następnie postępuj zgodnie z poniższymi instrukcjami.
...
.
2. U góry strony wybierz pozycję **Zarządzaj** \> **importowaniem kontaktów**.
3. Wybierz **pozycję Przeglądaj**, przejdź do folderu, w którym zostały zapisane wyeksportowane kontakty, a następnie wybierz pozycję **Otwórz**.
