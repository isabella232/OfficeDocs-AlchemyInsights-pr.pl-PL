...
ms.locfileid: "40052659"
---
# <a name="migrate-options-to-sharepoint-online"></a><span data-ttu-id="b74cc-102">Migrowanie opcji do usługi SharePoint Online</span><span class="sxs-lookup"><span data-stu-id="b74cc-102">Migrate options to SharePoint Online</span></span>

<span data-ttu-id="b74cc-103">Istnieją różne opcje dostępne do migracji zawartości do programu SharePoint w trybie online, w zależności od rozmiaru i ilości plików, które należy przenieść.</span><span class="sxs-lookup"><span data-stu-id="b74cc-103">There are different options available to migrate content to SharePoint Online, depending on the size and quantity of files you need to move.</span></span>
