...
Potrzebujesz pomocy przy włączaniu i konfigurowaniu funkcji dostępu gościa w programie Microsoft Teams?  

Najpierw upewnij się, że zostały wykonane wszystkie kroki opisane w [liście kontrolnej dostępu gościa](https://docs.microsoft.com/en-us/microsoftteams/guest-access-checklist). Po wykonaniu tych kroków, trzeba [poczekać do 24 godzin](https://docs.microsoft.com/en-us/microsoftteams/manage-guests#guest-access-latencies) , aby ustawienia zostały uwzględnione.
