...
- Aby wyświetlić listę sieci związane z dzierżawcy, zaloguj się na Yammer jako Administrator globalny Office 365 i przejdź do **Administratora sieci w organizacji**, następnie **Migracji sieci**. Wybierz **Następny**.
...
- **Sieci migracji migruje tylko aktywne i oczekujące użytkowników.** Wraz z aktywnych użytkowników użytkowników informacje, takie jak nazwa i zdjęcie profilu, również podlega migracji. Dowolna zawartość sieci, łącznie z grupami, nie jest migrowana. 
    
- **Nie można cofnąć migracji sieciowej.** Nie można uzyskać dostęp do sieci uzupełniającej wraz z zawartością po migracji. Dlatego przed podjęciem decyzji o migracji, chcesz starannie zaplanować. 
