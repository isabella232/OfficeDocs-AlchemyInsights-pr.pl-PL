...
Aby uzyskać więcej informacji na temat udostępniania zewnętrznych (gości) prosimy odwiedzić poniższe łącza.
...
- [Zarządzaj dostępem gościa w grupy usługi Office 365](https://docs.microsoft.com/office365/admin/create-groups/manage-guest-access-in-groups?view=o365-worldwide)
...
**Błąd z użytkowników zewnętrznych (Gość)?**

Sprawdź poniższe łącza. 

- [Udostępnianie OSE błędy w programie Sharepoint lub OneDrive](https://docs.microsoft.com/sharepoint/sharepoint-onedrive-error-message)
